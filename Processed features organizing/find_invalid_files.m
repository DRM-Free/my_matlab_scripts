...
invalidROIs=struct('featureFileName',"",'dataFileName',"");
otherInvalids=struct('featureFileName',"",'dataFileName',"");
    ...
    try
        ...
        if isequal(radiomics,'ERROR_ROI')
            if invalidROIs(end).featureFileName=="";
                ...
                invalidROIs(end+1)=struct('featureFileName',curFile,'dataFileName',"");
            end
            ...
            if otherInvalids(end).featureFileName=="";
                ...
                otherInvalids(end+1)=struct('featureFileName',curFile,'dataFileName',"");
            end
